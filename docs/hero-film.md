...
Flat cartoon animation. **Bold clean outlines, simplified shapes, flat colour
fills, no shading, no gradients, no highlights.** Simplified the way an animated
character is simplified — hair as clean shapes rather than strands, simple hands
— while his face stays recognisably his.

Simplify is not the same as exaggerate. Cartooning reduces detail to shapes;
caricature stretches features toward an archetype and loses the person. Keep the
hairline, brow, nose and jaw as they are, and drop the detail around them.

Flat colour is also the kindest thing you can hand a video model: no gradients
to band, no highlights to shimmer, no soft shading to boil.

### Cartoon the character sheet first

The sheet is soft-shaded and semi-realistic, so "match the reference" would
fight this. Convert it once, then use the cartoon version as the reference
everywhere:

> Redraw this character in a flat cartoon animation style. Bold clean outlines,
> simplified shapes, completely flat colour fills, no shading, no gradients, no
> highlights, no texture. Simplify his hair into clean shapes rather than
> individual strands and simplify the hands, but keep his face recognisably his
> — same hairline, same brow, same nose and jaw. Keep the outfit and the pose.
...
the same way in all four stills: **a very light grey flat fill on the t-shirt,
and the bold outline doing the rest.**

## The stills — ChatGPT, 16:9

**Attach the cartooned character sheet to all four**, including the vortex,
...
> The character in the reference image, drawn in exactly the same flat cartoon
> animation style — bold clean outlines, simplified shapes, completely flat
> colour fills, no shading, no gradients, no highlights. Same face and outfit,
> with a very light grey t-shirt. He is close to the camera, seen from behind
> from roughly the waist up, turning his head back over his left shoulder to
> look at the viewer, his left arm reaching back toward the camera with the hand
> open and near the lens. Pure white empty background — no floor, no horizon, no
> shadows, nothing but white.

**2 — The run**

> The character in the reference image, drawn in exactly the same flat cartoon
> animation style — bold clean outlines, simplified shapes, completely flat
> colour fills, no shading, no gradients. Same face and outfit, very light grey
> t-shirt. Seen from behind, running away from the camera into empty white
> space. Far ahead of him an old boxy black CRT television floats at the centre
> of the frame, its curved glass screen a flat grey no-signal tone. Pure white
> empty background — no floor, no horizon, no shadows.
...
> animation style — bold clean outlines, simplified shapes, completely flat
> colour fills, no shading, no gradients. Same face and outfit, very light grey
> t-shirt. Seen from behind, diving head first with both arms stretched forward
> toward a large old boxy black CRT television directly ahead. The television's
> curved glass screen fills much of the frame, a flat grey no-signal tone. Pure
> white empty background — no floor, no shadows.

**4 — The vortex**

> Looking down the inside of a swirling tunnel, drawn in the same flat cartoon
> animation style as the reference image — bold clean outlines, simplified
> shapes, completely flat colour fills, no shading, no gradients. Flat bands of
> colour spiralling down the tunnel. On the right wall a flat blurple-purple
> chat panel with rounded message bubbles. On the left wall flat video
